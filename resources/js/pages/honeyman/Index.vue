<template>
    <section class="min-h-screen bg-gray-100 text-gray-900 px-6 py-12">
        <div class="max-w-4xl mx-auto space-y-12">
            <!-- Header -->
            <div>
                <h1 class="text-4xl font-bold tracking-tight">HONEYMAN</h1>
                <p class="mt-2 text-lg text-gray-600">// What They Did. What I Saw. What I Carried.</p>
            ...
            <div class="space-y-4 text-base leading-relaxed">
                <p>
                    ...
                    What met me was not misunderstanding. What met me was system architecture: covert, coordinated, calculated.
                </p>
                <p>
                    This page is not a complaint. It is a <span class="font-semibold">record</span>.
                    It is a light cast backward over a sequence of events that reveal more than misconduct —
                    they reveal what happens when authenticity collides with institutional machinery.
                </p>
                <p class="italic">
                    Let this page stand as both witness and warning.
                </p>
            </div>

            <!-- Context -->
            <div>
                <h2 class="text-2xl font-semibold mt-10 mb-4">Context // Entry</h2>
                <ul class="list-disc list-inside text-gray-700">
                    <li>Volunteer position accepted: January 8, 2025</li>
                    <li>Arrival: January 31, 2025</li>
                    <li>Intended duration: 2 Months (End of March)</li>
                    <li>Dismissal: March 24, 2025 — one week before natural departure</li>
                </ul>
            </div>
...
<script setup>
// No script needed yet, but can be extended for dynamic content, routing, or analytics
</script>

<style scoped>
/* Additional stylization if needed */
</style>
