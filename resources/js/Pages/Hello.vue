<template>
    ...
    <div class="prose prose-neutral max-w-none prose-headings:font-semibold prose-headings:text-gray-900 prose-p:text-gray-700 prose-li:marker:text-gray-400 prose-strong:text-gray-900 prose-strong:font-semibold">
        ...
        <div class="flex flex-wrap justify-center gap-4 px-4 py-0 my-0 max-w-screen-md mx-auto not-prose">
            <img src="/assets/spotify1.jpg" alt="Spotify Stats" class="w-[40%] max-w-xs rounded-lg shadow-md" />
            <img src="/assets/spotify2.jpg" alt="Spotify Stats - Listening Clocks" class="w-[40%] max-w-xs rounded-lg shadow-md" />
        </div>
...
<style>
/* For future custom styles if needed */
</style>
