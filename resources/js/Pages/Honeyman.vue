<template>
    <div class="border border-gray-300 rounded-2xl pt-0 shadow-md bg-white w-full mx-auto">
        ...
        <section id="the-story-of-honeyman" class="mt-9 border-t border-gray-300 py-12 text-black">
            <div class="prose prose-neutral max-w-3xl mx-auto">
                ...
                <div class="mx-12">
                    ...
                    <h3 class="font-bold mt-4">The First Fracture</h3>
                    ...
                    <div>not with curiosity, but with rehearsed authority.</div>
                    ...
                    <h3 class="font-bold mt-4">Distortion as Policy</h3>
                    ...
                    <h3 class="font-bold mt-4">The Orchestrated Confrontation</h3>
                    ...
                    <h3 class="font-bold mt-4">The Final Move</h3>
                    ...
                    <h3 class="font-bold mt-4">What They Did</h3>
                    ...
                    <h3 class="font-bold mt-4">What I Did</h3>
        ...
        <section id="day-use-meeting" class="border-t border-gray-300 py-12 text-black">
            <div class="prose prose-neutral max-w-3xl mx-auto">
        ...
        <section id="call-with-allison-watson" class="border-t border-gray-300 py-12 text-black">
            <div class="prose prose-neutral max-w-3xl mx-auto">
        ...
        <section id="letter-to-allison" class="border-t border-gray-300 py-12 text-black">
            <div class="prose prose-neutral max-w-3xl mx-auto">
        ...
        <section id="naming-the-harm" class="border-t border-gray-300 py-12 text-black">
            <div class="prose prose-neutral max-w-3xl mx-auto">
