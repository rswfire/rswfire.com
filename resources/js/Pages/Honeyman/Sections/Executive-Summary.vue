        ...
        <div class="my-8 prose prose-neutral max-full mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 items-start md:items-baseline">
            ...
            <ul class="list-disc list-outside ml-8">
                ...
                <li><strong>March 10</strong>: Engagement Programs Manager Allison Watson called about my March 5 recording, informing me I was &quot;acting as an agent of the state&quot; and establishing notification requirements for future recordings &mdash; the tone was procedural, but it still felt intimidating. We had never spoken before.</li>
                <li><strong>That Same Day</strong>: In a follow-up call I initiated, and deliberately did not record so she would feel more comfortable, I tried to explain why I had recorded the meeting, hoping she would assist me. She told me to get through my time, that every park is different.</li>
                <li><strong>March 18</strong>: An unidentified man approached me to conduct covert assessment while I worked alone, interrogating me about leadership treatment under cover of &quot;IT documentation.&quot; I immediately documented it with Kati.</li>
