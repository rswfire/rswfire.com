<template>
    <section id="lessons-learned">
        <div class="my-8 prose prose-neutral max-full mx-auto">
            ...
            <div class="mt-4">Here's what I learned about staying whole in systems designed to break you apart.</div>

            <h2 class="mt-8 text-xl font-semibold">THE FRAGMENTATION PLAYBOOK</h2>
            <div class="mt-4"><strong>How institutions fragment people:</strong></div>
            <div class="mt-4"><strong>Isolation</strong> &mdash; They separate you from allies, information, and support systems. Logan disappearing when I needed backup. Rangers being conveniently away during critical moments.</div>
            <div class="mt-4"><strong>Reframing</strong> &mdash; They take your reasonable responses and pathologize them. My clear communication became &quot;aggressive.&quot; My boundary-setting became &quot;problematic.&quot;</div>
            <div class="mt-4"><strong>Gaslighting</strong> &mdash; They make you doubt your own perception. Was Ryan really that hostile? Was that meeting actually coercive? The recordings proved my sanity.</div>
            <div class="mt-4"><strong>Manufactured Scarcity</strong> &mdash; They create artificial urgency and pressure. &quot;You could just leave if you're uncomfortable.&quot; Making my continued presence feel like a burden.</div>
            <div class="mt-4"><strong>Identity Splitting</strong> &mdash; They force you to choose between authentic self-expression and institutional acceptance. My queerness, my depth, my integrity &mdash; all became &quot;unprofessional.&quot;</div>
            <div class="mt-4"><strong>Narrative Poisoning</strong> &mdash; They tell stories about you to others that create distance and doubt. Colleagues start treating you differently. Your reputation gets quietly damaged. People avoid you without knowing why. Ryan's insinuation that I had &quot;inappropriate feelings&quot; for Logan, spread to others, weaponizing both my sexuality and normal human connection.</div>
            <div class="mt-4"><strong>Historical Erasure</strong> &mdash; They deny patterns, refuse documentation, disappear evidence. &quot;No paperwork exists&quot; for my dismissal. My follow-up letter was never acknowledged.</div>
            <div class="mt-4">The goal isn't to destroy you outright. It's to make you fragment yourself &mdash; to teach you to self-police, self-silence, self-manage until you become complicit in your own diminishment.</div>

            <h2 class="mt-8 text-xl font-semibold">STAYING WHOLE: PRACTICAL RESISTANCE</h2>
            ...
            <ul class="list-disc list-outside ml-8">
                ...
                <li><strong>Keep personal copies</strong>. Don't rely on company systems. Use personal email, personal cloud storage.</li>
            </ul>
            ...
            <ul class="list-disc list-outside ml-8">
                ...
                <li><strong>Track escalation</strong>. Small conflicts that become big issues overnight usually indicate orchestrated pressure.</li>
            </ul>
            ...
            <ul class="list-disc list-outside ml-8">
                ...
                <li><strong>Keep perspective</strong>. Their institutional chaos is not your personal failure.</li>
            </ul>
            ...
            <ul class="list-disc list-outside ml-8">
                ...
                <li><strong>Have an exit strategy</strong>. Financial cushion, alternative opportunities, places to land if they push you out.</li>
            </ul>

            <h2 class="mt-8 text-xl font-semibold">WHAT TO DO WHEN THE SYSTEM TURNS ON YOU</h2>
            ...
            <ul class="list-disc list-outside ml-8">
                ...
                <li>A very good resource now is to discuss it with <strong>artificial intelligence</strong>.</li>
            </ul>
            ...
            <h2 class="mt-8 text-xl font-semibold">THE DEEPER WORK: HEALING FROM INSTITUTIONAL TRAUMA</h2>
            ...
            <ul class="list-disc list-outside ml-8">
                ...
                <li><strong>Fragmented identity</strong> &mdash; Feeling like you have to hide parts of yourself to be acceptable.</li>
            </ul>
            ...
            <ul class="list-disc list-outside ml-8">
                ...
                <li><strong>Engage in work that honors your values</strong>. Find environments that reward integrity instead of punishing it.</li>
            </ul>

            <h2 class="mt-8 text-xl font-semibold">FOR ALLIES AND WITNESSES</h2>
            ...
            <h2 class="mt-8 text-xl font-semibold">THE LARGER CONTEXT</h2>
            <div class="mt-4"><strong>What happened to me at Honeyman wasn't unique. It's how institutions maintain control</strong>:</div>
            <div>They fragment us so we can't organize.</div>
            <div>They isolate us so we can't compare experiences.</div>
            <div>They pathologize resistance so we police ourselves.</div>
            <div>They erase documentation so patterns stay invisible.</div>
            <div class="mt-4">The antidote isn't individual resilience &mdash; though that matters. The antidote is collective refusal to fragment. When we document, witness, and support each other, we make their strategies visible and therefore less effective.</div>

            <div class="mt-4"><strong>This archive exists because I refused to fragment</strong>. I maintained my integrity, documented their tactics, and preserved the evidence they tried to erase.</div>
            <div class="mt-4">Most people can't build something this comprehensive. But everyone can practice the principles: stay whole, document patterns, seek external perspective, and refuse to absorb institutional narratives that diminish your humanity.</div>
            <div class="mt-4"><strong>The goal isn't to become invulnerable</strong>. It's to <em>hold your shape</em>. The goal is to remain yourself &mdash; integrated, ethical, and clear &mdash; even when systems pressure you to become someone smaller.</div>
            <div class="mt-4">That's how we transform institutions: one person at a time refusing to fragment.</div>
