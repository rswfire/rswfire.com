<template>
    <section id="the-unidentified-man" class="border-t border-gray-300">
        <div class="my-8 prose prose-neutral max-full mx-auto">
            <h2 class="text-2xl font-semibold">THE UNIDENTIFIED MAN</h2>
            <div class="italic text-gray-600">MARCH 18, 2025 &mdash; THE MOMENT THEY TRIED TO FRAME ME</div>

            <div class="mt-4">Six days before my removal from Honeyman State Park, I encountered something that still defies reasonable explanation.</div>
            <div class="mt-4">I was alone at the yurts, mid-clean, with all doors propped open as part of my routine. The rangers were away at a regional training event. It was quiet, methodical work &mdash; the kind I had come to appreciate.</div>
            <div class="mt-4">A man approached. No uniform. No identification. No introduction.</div>
            <div class="mt-4">He claimed to be with the park service and said he was photographing the yurts for documentation &mdash; while they were dirty, partially cleaned, completely exposed. Then, without transition, he began pressing me with direct, personal questions about my experience at the park, how I was being treated, whether leadership was treating me well.</div>
            <div class="mt-4">This was not casual conversation. It was interrogation. Calculated, pressured, intimate. When I didn't respond as expected, he stepped closer, reframed the questions, increased the psychological pressure.</div>
            <div class="mt-4">I recognized what was happening in real time. This was a probe &mdash; designed to elicit complaints, create admissible statements, or provoke a reaction that could be used to justify my removal.</div>
            <div class="mt-4">I documented the encounter immediately with Kati, my supervisor. Her response was swift: he was &quot;from I.T.&quot; taking photos for site documentation. She praised how I had &quot;handled it.&quot;</div>
            ...
            <div class="text-xs font-bold">Correction: This encounter took place on March 18, not March 20, making it six days before my removal.</div>
            ...
            <div class="mt-4 max-h-[40rem] overflow-y-auto border border-gray-300 rounded-md shadow-inner bg-white p-4 leading-relaxed font-mono">
                ...
                <div class="mt-4">Four days before I was removed from Honeyman, a man approached me while I was cleaning the yurts.</div>
                ...
                <div class="mt-4">This was not casual.</div>
                ...
                <div class="mt-4">There is no public record of these photos ever being used.</div>

                <div class="mt-4">There is no traceable operational need for unannounced photo capture during an active clean.</div>

                <div class="mt-4">There was no follow-up, no supervisor debrief, no procedural accountability.</div>
                ...
                <div class="mt-4">Do those photos exist?</div>

                <div class="mt-4">Were they ever published?</div>

                <div class="mt-4">Was this encounter logged anywhere in your internal systems?</div>

                <div class="mt-4">Because if not, you now have something far worse than negligence.</div>
                <div>You have a covert institutional tactic used against a volunteer &mdash; followed by a pattern of containment and silence.</div>

                <div class="mt-4">Something I endured for two months. I just wanted to get through my time there so I could move onto the other parks in my trajectory. Kati knew that. Ryan knew that. And that's why they were trying so hard to frame me as a problem. It's why they removed me when I only had ONE SHIFT LEFT.</div>

                <div class="mt-4">This is what Kati did to someone who was doing his job.</div>
                <div>Unpaid. Alone. Professional.</div>

                <div class="mt-4">And this is what Allison did in response: nothing.</div>
                ...
                <div class="mt-4">I know you don't want to hear from me. I know the institutional reflex to frame this as obsession. This is not that. I need you to be an ethical leader.</div>

                <div class="mt-4">Find a way.</div>

                <div class="mt-4">&mdash;Sam</div>
                <div>https://rswfire.com/honeyman</div>


                <div class="mt-8">From: Robert Samuel White &lt;rsw@rswfire.com&gt;</div>
                <div>Sent: Monday, May 26, 2025 7:08:05 PM</div>
                <div>To: WATSON Allison * OPRD &lt;allison.watson@oprd.oregon.gov&gt;</div>
                <div>Subject: For the Record - March 20 Field Encounter</div>

                <div class="mt-4">Allison,</div>
                ...
                <div class="mt-4">This wasn’t routine.</div>
                <div>It was covert assessment, masked as operations.</div>

                <div class="mt-4">And I see now what it was meant to be:</div>
                ...
                <div class="mt-4">This email chain remains &mdash; a quiet record of that moment.</div>
                <div>You may want to review it with clearer eyes.</div>

                <div class="mt-4">Because what happened at that park is larger than policy.</div>
                <div>It speaks to the architecture of how authenticity is policed, how nonconformity is treated as threat, and how systems recruit silence to cover their own fractures.</div>

                <div class="mt-4">I am not asking for response.</div>
                <div>I am not seeking closure.</div>
                <div>But I will not let distortion have the last word.</div>

                <div class="mt-4">This message is not about me.</div>
                ...
                <div class="mt-8">From: Robert Samuel White &lt;rsw@rswfire.com&gt;</div>
                <div>Sent: Thursday, March 20, 2025 3:48:24 PM</div>
                <div>To: Baker Kati * OPRD &lt;Kati.BAKER@oprd.oregon.gov&gt;</div>
                <div>Subject: Re: Question About Unidentified Visitor</div>

                <div class="mt-4">Thanks, Kati. Hope it's not a problem he took the photos before I'd cleaned them. All three of my sites were in the little alcove so I had all three open at the same time while I moved around all three doing my different tasks. Like, I had the sanitizer going in all three whole I blowed the sites, etc. The trash cans were propping all the doors open. I'd want the photos to look nice of course!</div>


                <div class="mt-8">From: Baker Kati * OPRD &lt;Kati.BAKER@oprd.oregon.gov&gt;</div>
                <div>Sent: Thursday, March 20, 2025 3:43:44 PM</div>
                <div>To: Robert Samuel White &lt;rsw@rswfire.com&gt;</div>
                <div>Subject: RE: Question About Unidentified Visitor</div>

                <div class="mt-4">Sam,</div>

                <div class="mt-4">Just wanted to let you know I did reach out to the I.T. employee who is spearheading the site photo updates and it was indeed them who was out getting photos of yurts in A loop 😊</div>

                <div class="mt-4">Have a great afternoon!</div>

                <div class="mt-8">From: Robert Samuel White &lt;rsw@rswfire.com&gt;</div>
                <div>Sent: Tuesday, March 18, 2025 5:35 PM</div>
                <div>To: Baker Kati * OPRD &lt;Kati.BAKER@oprd.oregon.gov&gt;</div>
                <div>Subject: Re: Question About Unidentified Visitor</div>

                <div class="mt-4">Thanks for confirming!</div>


                <div class="mt-4">From: Baker Kati * OPRD &lt;Kati.BAKER@oprd.oregon.gov&gt;</div>
                <div>Sent: Tuesday, March 18, 2025 5:31:49 PM</div>
                <div>To: Robert Samuel White &lt;rsw@rswfire.com&gt;</div>
                <div>Subject: Re: Question About Unidentified Visitor</div>

                <div class="mt-4">Hi Sam,</div>

                <div class="mt-4">We have had some staff from I.T. working on getting updated photos of sites all over the state. I think you handled it wonderfully asking if they had any other questions. It’s not unusual for folks to want to take a look inside especially if they haven’t seen a yurt before. I can follow up with folks in I.T. to see if anyone was out today :)</div>

                <div class="mt-4">-Kati</div>


                <div class="mt-8">From: Robert Samuel White &lt;rsw@rswfire.com&gt;</div>
                <div>Sent: Tuesday, March 18, 2025 4:35 PM</div>
                <div>To: Baker Kati * OPRD &lt;kati.baker@oprd.oregon.gov&gt;</div>
                <div>Subject: Question About Unidentified Visitor</div>

                <div class="mt-4">Hi Kati,</div>
