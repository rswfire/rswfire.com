<template>
    <div class="fixed inset-0 z-50 bg-white text-gray-900 flex flex-col justify-between px-6 py-8 overflow-y-auto">
        ...
        <div class="space-y-6">
            ...
            <div class="w-full flex justify-center">
                <div class="flex items-center space-x-2">
                    <Link href="/about" @click="$emit('close')" class="text-sm font-medium text-gray-700 hover:underline">
                    ...
                    <Link href="/login" @click="$emit('close')" class="text-sm font-medium text-gray-700 hover:underline">
                    ...
                    <div class="space-x-4">&nbsp;</div>
                    <Link href="/register" @click="$emit('close')" class="text-sm font-medium text-gray-700 hover:underline">
