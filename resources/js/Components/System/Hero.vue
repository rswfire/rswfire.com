...
const themeIcons = [
    ...
    { label: "Atlas",    icon: "MapPinHouse", color: "text-sky-400",    bg: "bg-sky-50",    border: "border-sky-200",    hover: "hover:bg-sky-100",    url: "/atlas" },
    ...
    { label: "Synthesis",     icon: "Crosshair",         color: "text=purple-400", bg: "bg-purple-50", border: "border-purple-200", hover: "hover:bg-purple-100", url: "/synthesis" },

    { label: "Lineage",  icon: "Trees",          color: "text=purple-400",  bg: "bg-purple-50",  border: "border-purple-200",  hover: "hover:bg-purple-100",  url: "/lineage" },
