<template>
  ...
  <!-- Desktop header (fixed; shown md+) -->
  <Header :authUser="authUser" class="hidden md:block" />

  <!-- Mobile top bar (sticky; shown < md) -->
  <div class="md:hidden">
  ...
  <!-- ONE shared main for both mobile + desktop -->
  <!-- mobile: normal flow + py-4; desktop: add top padding to clear fixed header -->
