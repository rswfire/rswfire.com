...
const itemsReference = [
    { label: "LINEAGE",   icon: "Layers",        color: "text-purple-400",    bg: "bg-purple-50",    border: "border-purple-200",    hover: "hover:bg-purple-100",    url: "/lineage",   blurb: "Field manual for the Sanctum community." },
